...
public class ROI2ImageJTest extends BasicTest {
    ...
    public void testROIsFromImageJ() {
        ...
        List<ROIWrapper> omeroROIs = ROIWrapper.fromImageJ(null, rois);
    ...
    public void convertEllipse() {
        ...
        ROIWrapper roi = ROIWrapper.fromImageJ(null, roiList).get(0);
    ...
    public void convertRectangle() {
        ...
        ROIWrapper roi = ROIWrapper.fromImageJ(null, roiList, null).get(0);
    ...
    public void convertLine() {
        ...
        List<Roi> roiList = new ArrayList<>(1);
        roiList.add(ijLine);
        ROIWrapper roi = ROIWrapper.fromImageJ(null, roiList, ROIWrapper.IJ_PROPERTY).get(0);
